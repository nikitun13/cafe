...
public class ToNotCollectedOrdersCommand implements Command {
    ...
    private static final Logger log
            = LogManager.getLogger(ToNotCollectedOrdersCommand.class);
    ...
    public ToNotCollectedOrdersCommand(ServiceFactory serviceFactory) {
    ...
    public Dispatch execute(HttpServletRequest request,
        ...
        try {
            orderProcessService.toNotCollectedOrders(orders);
