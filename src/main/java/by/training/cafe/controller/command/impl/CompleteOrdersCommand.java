...
/**
 * The class {@code CompleteOrdersCommand} is a class that
...
public class CompleteOrdersCommand implements Command {
    ...
    private static final Logger log
            = LogManager.getLogger(CompleteOrdersCommand.class);
    ...
    public CompleteOrdersCommand(ServiceFactory serviceFactory) {
    ...
    public Dispatch execute(HttpServletRequest request,
        ...
        try {
            ...
            orderProcessService.completeOrders(orders);
