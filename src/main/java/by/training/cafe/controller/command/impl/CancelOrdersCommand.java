...
/**
 * The class {@code CancelOrdersCommand} is a class that
 ...
 * @see Command
 */
public class CancelOrdersCommand implements Command {

    private static final Logger log
            = LogManager.getLogger(CancelOrdersCommand.class);
    ...
    public CancelOrdersCommand(ServiceFactory serviceFactory) {
    ...
    public Dispatch execute(HttpServletRequest request,
        ...
        try {
            orderProcessService.cancelOrders(orders);
